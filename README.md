# Um Hotel em Terabithia: Desafios em JavaScript
...
## Para acessar o sistema do Hotel Terabithia:

1. **Opção 1**: Baixe o arquivo zip deste repositório e acesse o arquivo em sua IDE.

2. **Opção 2**: Acesse o site no ar através do link disponível no canto superior direito do repositório do Github.
<hr>
...
- Calcule o valor total do serviço a partir do valor por aparelho e da quantidade de aparelhos. Aplique sobre esse valor o desconto, caso a quantidade de aparelhos seja maior que a mínima informada para que haja desconto.
- Ao fim mostre a mensagem “O serviço de [nome da empresa] custará R$ [total calculado]”.
